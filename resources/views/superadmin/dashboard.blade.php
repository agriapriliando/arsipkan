        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-start gap-4">
            <div>
                ...
                <div class="d-flex flex-wrap gap-2 mt-4">
                    <a href="{{ route('superadmin.tenants.index') }}" class="btn btn-brand">Kelola Tenant</a>
                    <a href="{{ route('superadmin.admins.index') }}" class="btn btn-outline-brand">Kelola Admin Tenant</a>
                    <a href="{{ route('superadmin.master-data.index') }}" class="btn btn-outline-brand">Master Data Tenant</a>
                    <a href="{{ route('superadmin.upload-links.index') }}" class="btn btn-outline-brand">Link Upload Tenant</a>
                </div>
            </div>
            ...
            <div class="info-card p-4" style="min-width: min(100%, 320px);">
                ...
                <div class="text-secondary">Gunakan area ini untuk manajemen tenant, kuota storage, dan admin tenant.</div>
            </div>
        </div>
    </section>
@endsection
